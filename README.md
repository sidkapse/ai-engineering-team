...
A **CrewAI** multi-agent system that turns natural-language requirements into a complete Python solution: a backend module, a design document, a Gradio UI, and unit tests. The crew behaves like a small engineering team—design, backend, frontend, and QA—working in sequence.
